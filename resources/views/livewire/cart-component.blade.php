        ...
        <div class=" main-content-area">
                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            ...
                            <p class="text-center"><a href="#" wire:click.prevent="switchToSaveFolder('{{ $item->rowId }}')">Save for later</a></p>
                        </div>
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    <p class="summary-info"><span class="title">Discount {{ session('coupon')['code'] }}</span><b class="index"> - ${{ number_format($discount,2) }}</b></p>
                ...
                <div class="checkout-info">
                    ...
                    <label class="checkbox-field">
                        <input class="frm-input " name="have-code" id="have-code" value="1" type="checkbox" wire:model="haveCouonCode"><span>I have coupon code</span>
                    </label>
                            ...
                            <div class="summary_item">
                                <form wire:submit.prevent="applyCouponCode">
                                    ...
                                    <p class="row_in_form">
                                        ...
                                        <input  class="form-control" name="coupon-code" type="text" wire:model="CouponCode">
                                    </p>
            ...
            <div class="wrap-iten-in-cart">
                ...
                <div class="alert alert-success">{{ Session::get('s_success_message') }}</div>
                @endif
                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="price-field sub-total"><p class="price">${{ $item->subtotal }}</p></div>
                        <div class="delete">
                            <a href="#" class="btn btn-delete" wire:click.prevent="deleteFromForLater('{{ $item->rowId }}')" title="">
